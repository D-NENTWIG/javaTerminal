...
public class LsTest {
    ...
    public void goIntoTempfolder() throws IOException {
        ...
        FilePather.setCurrentDirectory(folder.getRoot().getAbsolutePath());
    }
    ...
    public void testLsWithTooManyArgs() throws IOException {
        ...
        try {
            PipedInputStream in = new PipedInputStream();
            PipedOutputStream out = new PipedOutputStream(in);
            Shell.eval("ls foo bar foobar", out);
        } catch (RuntimeException expected) {
            assertTrue(expected.getMessage().contains("ls: too many args"));
        }
    ...
    public void testLsWithInvalidDirectory() throws IOException {
        ...
        try {
            PipedInputStream in = new PipedInputStream();
            PipedOutputStream out = new PipedOutputStream(in);
            Shell.eval("ls fakeDirectory", out);
        } catch (RuntimeException expected) {
